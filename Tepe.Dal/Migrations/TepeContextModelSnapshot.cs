...
{
    [DbContext(typeof(TepeContext))]
    partial class TepeContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tepe.Entities.Concrete.Note", b =>
                {
            ...
            modelBuilder.Entity("Tepe.Entities.Concrete.Student", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LessonStudent", b =>
                {
                    b.HasOne("Tepe.Entities.Concrete.Lesson", null)
                        .WithMany()
                        .HasForeignKey("LessonsLessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tepe.Entities.Concrete.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tepe.Entities.Concrete.Note", b =>
                {
                    b.HasOne("Tepe.Entities.Concrete.Lesson", "Lessons")
                        .WithMany("Notes")
